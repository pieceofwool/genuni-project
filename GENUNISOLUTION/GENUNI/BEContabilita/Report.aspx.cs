...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void CaricaGrigliaDocenti()
    {
        ...
        grigliaReportDocenti.DataSource = C.ListaSpese(txtDataInizio.Text, txtDataFine.Text);
    ...
    protected void CaricaGrigliaStudenti()
    {
        ...
        grigliaReportStudenti.DataSource = C.ListaRicavi(txtDataInizio.Text, txtDataFine.Text);
