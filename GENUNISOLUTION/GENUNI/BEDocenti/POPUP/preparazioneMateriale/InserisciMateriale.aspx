<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InserisciMateriale.aspx.cs" Inherits="BEDocenti_POPUP_preparazioneMateriale_InserisciMateriale" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnInserisciMateriale" runat="server" Text="Inserisci " OnClick="btnInserisciMateriale_Click" />
        </div>
    </form>
</body>
</html>
