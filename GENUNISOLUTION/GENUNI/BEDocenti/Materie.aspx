<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Materie.aspx.cs" Inherits="BEDocenti_POPUP_Visualizza_corso_Visualizza_Corso" %>
...
<body>
   ...
   <table>
       ...
       <tr><td><asp:Label ID="lblStatus" runat="server" Text="Status: "></asp:Label><asp:Literal ID="ltlStatus" runat="server"></asp:Literal></td></tr>
            ...
            <asp:GridView ID="grvMaterie" runat="server" OnSelectedIndexChanged="grvMaterie_SelectedIndexChanged" DataKeyNames="Chiave">
                <Columns>
                    <asp:ButtonField ButtonType="Button" Text="Scegli materia" />
                </Columns>
            </asp:GridView>
