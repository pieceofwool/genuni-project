...
public partial class MasterPageFE : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CodiceAttore"] != null)
        {
            ...
            AreaRiservata(usertype, greeting[dice], Nome);

        }
    }

    protected void AreaRiservata(string usertype, string greeting, string Nome)
    {
        switch (usertype)
        {
            case "A":
                litUserSpace.Text = "<li class=\"drop-down\"><a role=\"link\" aria-disabled=\"true\">" + greeting + Nome + "</a>";
            ...
            case "T":
                litUserSpace.Text = "<li class=\"drop-down\"><a role=\"link\" aria-disabled=\"true\">" + greeting + Nome + "</a>";
                litUserSpace.Text += "<ul>";
                litUserSpace.Text += "<li><a href=\"BETutor/SITUAZIONE_CORSI/situazioneCorsi.aspx\">Area Riservata</a></li>";
                litUserSpace.Text += "<li><a href=\"LogOut.aspx\">Logout</a></li>";
                litUserSpace.Text += "</ul>";
                litUserSpace.Text += "</li>";
                break;
            ...
            case "D":
                litUserSpace.Text = "<li class=\"drop-down\"><a role=\"link\" aria-disabled=\"true\">" + greeting + Nome + "</a>";
                litUserSpace.Text += "<ul>";
                litUserSpace.Text += "<li><a href=\"BEDocenti/Profilo.aspx\">Area Riservata</a></li>";
                litUserSpace.Text += "<li><a href=\"LogOut.aspx\">Logout</a></li>";
                litUserSpace.Text += "</ul>";
                litUserSpace.Text += "</li>";
                break;
